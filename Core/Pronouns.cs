...
public static class Pronouns
{
	...
	public static readonly Pronoun They = new(Key + "They.S", Key + "They.O", Key + "They.P");
	public static readonly Pronoun She = new(Key + "She.S", Key + "She.O", Key + "She.P");
	public static readonly Pronoun He = new(Key + "He.S", Key + "He.O", Key + "He.P");
	public static readonly Pronoun It = new(Key + "It.S", Key + "It.O", Key + "It.P");
}